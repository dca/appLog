...
angular.module("dlog", [ "ngResource", "elasticjs.service", "btford.socket-io", "ui.bootstrap" ]).config(function(socketProvider) {
    var mySocket = io.connect("http://localhost:9603");
    socketProvider.ioSocket(mySocket);
}), angular.module("dlog").controller("LoggerCtrl", function($scope, ejs, socket) {
...
}), angular.module("dlog").factory("Logs", function() {
    return this;
}), angular.module("dlog").factory("ejs", function($q, $http, ejsResource) {
    function ESQuery() {
